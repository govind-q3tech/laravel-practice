...
<x-slot name="breadcrumb">
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
          ...
          {{ Breadcrumbs::render('common',['append' => [['label'=> 'General Settings', 'route'=> \Request::route()->getName()]]]) }}
        </div>
      </div>
</x-slot>
<?php
                  ...
                  <tr class="row-{{ $setting->id }}">
                      ...
                      <td class="actions">
                          ...
                          <div class="form-group">
                              <a href="{{ route('admin.settings.show', $setting->id) }}" class="btn btn-warning btn-xs" data-toggle="tooltip" alt="View Setting Detail" title="View Setting" data-original-title="View"><i class="fa fa-fw fa-eye"></i></a>
                              @if($canCreate)
                              ...
                              @endif
                              <!-- <a href="javascript:void(0);" class="confirmDeleteBtn btn btn-danger btn-xs" data-toggle="tooltip" data-action="DELETE" alt="Delete {{ $setting->name }}" title="Delete Setting" data-url="{{ route('admin.settings.destroy', $setting->id) }}" data-title="{{ $setting->name }}"><i class="fa fa-trash"></i></a> -->
                          </div>
                      </td>
                  </tr>
                @php
